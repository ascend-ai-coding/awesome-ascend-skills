---
name: external-gitcode-ascend-ascend-verl-prepare-data
...
传递参数时不交互：
```bash
skill ascend-verl-prepare-data(
  DATASET_NAME="gsm8k",
...
```
[主skill调用ascend-verl-prepare-data]
参数: DATASET_NAME=gsm8k, VERL_DATA_DIR=/home/datasets
执行: skill ascend-verl-prepare-data(DATASET_NAME, VERL_DATA_DIR, HTTP_PROXY, HTTPS_PROXY, VERL_CONTAINER)
结果: ready ✓
```
